	...
	<div class="flex gap-x-5 items-center mt-2">
		<div class="w-full">
			...
			>
				<img
					:src="
						dataStore.imageServer + dataStore.fieldsData.images[propsId].value
					"
			...
			>
				...
				<div class="modal-body relative p-4 mt-3">
					<div class="flex gap-3 mb-3">
						<div v-for="(image, index) in dataStore.fieldsData.uploadedImages">
							<div
								:class="
									index == dataStore.refData.currentSelectedImage
					...
					<button
						:class="selectBtnColor + ' text-white px-2 py-1 rounded-md'"
						data-bs-dismiss="modal"
